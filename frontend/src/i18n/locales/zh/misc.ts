export default {
  ...
  payment: {
    ...
    estimatedCredited: '预计到账',
    rechargeMultiplier: '到账倍率',
    quickAmounts: '快捷金额',
    customAmount: '自定义金额',
    enterAmount: '输入金额',
    paymentMethod: '支付方式',
    ...
    errors: {
      ...
      ONE_TIME_SUBSCRIPTION_ALREADY_PURCHASED: '该订阅每位用户仅限一次，您已购买过',
      ONE_TIME_SUBSCRIPTION_PENDING: '该限购订阅已有待支付订单，请先完成或取消该订单',
      ONE_TIME_SUBSCRIPTION_UNAVAILABLE: '该订阅每位用户仅限一次，当前不可再次购买',
    ...
    planCard: {
      ...
      unlimited: '无限制',
      models: '模型',
      oneTimeOffer: '首充送50刀 · 每位用户限购一次',
      alreadyPurchased: '已购买，不可再次订阅',
      pendingOrder: '已有待支付订单',
    },
    days: '天',
    weeks: '周',
    months: '个月',
