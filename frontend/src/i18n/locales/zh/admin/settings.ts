export default {
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: '基础到账倍率；实际到账倍率还会乘以下方美元换算汇率',
        balanceRechargePreview: '预览：1 CNY = {usd} USD',
        subscriptionUsdToCnyRate: '充值/订阅美元换算汇率',
        subscriptionUsdToCnyRateHint:
          '余额充值的实际到账倍率会乘以此汇率；CNY 支付通道下，套餐每 1 USD 价格也按此汇率收取 CNY（如 7.15）。0 或留空时倍率按 1 计算，订阅按 price 数值直接收款',
