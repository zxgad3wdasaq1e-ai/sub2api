export default {
  ...
  payment: {
    ...
    estimatedCredited: 'Estimated Credit',
    rechargeMultiplier: 'Credit Multiplier',
    ...
    errors: {
      ...
      ONE_TIME_SUBSCRIPTION_ALREADY_PURCHASED: 'This subscription is limited to one purchase per user and has already been purchased.',
      ONE_TIME_SUBSCRIPTION_PENDING: 'A pending order already exists for this one-time subscription. Complete or cancel it first.',
      ONE_TIME_SUBSCRIPTION_UNAVAILABLE: 'This subscription is limited to one purchase per user and is no longer available.',
    ...
    planCard: {
      ...
      unlimited: 'Unlimited',
      models: 'Models',
      oneTimeOffer: '$50 first-purchase bonus · One per user',
