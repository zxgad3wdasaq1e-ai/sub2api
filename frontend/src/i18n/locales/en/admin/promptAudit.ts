export default {
  promptAudit: {
    ...
    saveBar: { enabled: 'Enable prompt audit', blocking: 'Synchronous blocking', storePass: 'Store safe events', storeFullPrompt: 'Store full prompts', dirty: 'Unsaved changes', synced: 'Configuration synced' },
    blockingConfirm: {
