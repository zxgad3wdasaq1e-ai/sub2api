...
type storageConfig struct {
	...
	StoreFullPrompt bool              `json:"store_full_prompt"`
...
func PublicFromStorage(cfg storageConfig, riskControlEnabled bool) PublicConfig {
	...
	active := ActiveConfig{RiskControlEnabled: riskControlEnabled, Enabled: cfg.Enabled, BlockingEnabled: cfg.BlockingEnabled, StoreFullPrompt: cfg.StoreFullPrompt}
	return PublicConfig{
		Enabled: cfg.Enabled, BlockingEnabled: cfg.BlockingEnabled, StorePassEvents: cfg.StorePassEvents, StoreFullPrompt: cfg.StoreFullPrompt,
...
func ActiveFromStorage(cfg storageConfig, riskControlEnabled bool, encryptor SecretEncryptor) (ActiveConfig, error) {
	active := ActiveConfig{
		...
		StoreFullPrompt: cfg.StoreFullPrompt,
...
func changeSummary(cfg storageConfig) string {
	...
	}{cfg.Enabled, cfg.BlockingEnabled, cfg.StorePassEvents, cfg.StoreFullPrompt, len(cfg.Endpoints), len(cfg.Scanners), cfg.AllGroups, len(cfg.GroupIDs), ""}
